...
<title><fmt:message bundle="${msg }" key="password_setting_by_token_form.title" /></title>
			...
			<div class="container" style="margin-top: 5em">
				<form class="form-horizontal" action="setNewPasswordByToken"
					...
					<fieldset>
						...
						<!-- Form Name -->
						<legend><fmt:message bundle="${msg }" key="password_setting_by_token_form.form_name" /></legend>
						...
						<div class="control-group">
							...
							<div class="controls">
								<button id="button" name="button" class="btn btn-primary"><fmt:message bundle="${msg }" key="password_setting_by_token_form.send" /></button>
							</div>
						</div>
